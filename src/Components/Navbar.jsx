        ...
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center space-x-2">
            ...
            <div className="w-8 h-8   rounded-full gradient-bg flex items-center justify-center">
              <span className="text-2xl  font-extrabold text-white "><span className=" bg-[linear-gradient(to_right,#8389f2,#e449a4)] bg-clip-text text-transparent">Roommate</span>Finder</span>
            </div>
            <div
              className="sm:hidden absolute left-0 top-18 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden"
              role="menu"
